...
## Resümee der Übung
  Gewisse Aufgaben sind für den Prozessor kein großer Aufwand. Für zum Beispiel Additionen oder Multiplikationen hat der Prozessor eigene Befehle.  
  Allerdings Aufgaben wie Dividieren dauern recht lange, da unser Prozessor keinen eigenen Maschinenbefehl für das Dividieren besitzt.  
  Auch größere Variablen bereiten dem Prozessor "Probleme".  
  Diese "Probleme" äußern sich als eine für die Abarbeitung des Prozesses höhere benötigte Zeit.
